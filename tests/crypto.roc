...
# and hash functions (hash!, hash_file!).
...
test_hash! = |{}|
    ...
    expect_eq(
        ...
        Crypto.hash!(Str.to_utf8("The quick brown fox jumps over the lazy dog"), "SHA-1"),
    )?
...
test_hash_file! = |{}|
    ...
    test_path = "test_hash_file.tmp"
    empty_path = "test_hash_empty.tmp"
